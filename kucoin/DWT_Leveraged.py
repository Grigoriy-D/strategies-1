...
class DWT_Leveraged(IStrategy):
    ...
    entry_long_dwt_diff = DecimalParameter(0.1, 9.0, decimals=1, default=2.0, space='buy', load=True, optimize=True)
    entry_short_dwt_diff = DecimalParameter(-9.0, -0.1, decimals=1, default=-2.0, space='buy', load=True, optimize=True)
    ...
    exit_long_dwt_diff = DecimalParameter(-9.0, -0.1, decimals=1, default=-2.0, space='sell', load=True, optimize=True)
    exit_short_dwt_diff = DecimalParameter(0.1, 9.0, decimals=1, default=2.0, space='sell', load=True, optimize=True)
