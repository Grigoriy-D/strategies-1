...
import tft_dataformatters_base
import tft_utils as utils
import numpy as np
import pandas as pd
...
# Default input types.
InputTypes = tft_dataformatters_base.InputTypes
...
class TemporalFusionTransformer(object):
  ...
  def get_tft_embeddings(self, all_inputs):
    ...
    obs_inputs = tf.keras.backend.stack([
        ...
        # convert_real_to_embedding(regular_inputs[Ellipsis, i])
        for i in self._input_obs_loc
    ],
        axis=-1)
