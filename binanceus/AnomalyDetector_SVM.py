# class that implements an Anomaly detector using the One Class Support Vector Machine algorithm
...
class AnomalyDetector_SVM(ClassifierSklearn):
    ...
    def create_classifier(self):
        classifier = OneClassSVM(gamma='scale', nu=self.contamination)
        return classifier
