# Neural Network Binary Classifier: this subclass uses a complex Multi-Layer Perceptron model
...
class NNBClassifier_MLP2(ClassifierKerasBinary):
    is_trained = False
